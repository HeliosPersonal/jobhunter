...
>
> **The gate is re-run per task, not per feature.** Following the SDLC audit
> ([[SDLC-AUDIT]], resolved by [[AUDIT-RESOLUTION-DECISIONS]] §7), this document no longer certifies
> whole features "Ready". Each task's own readiness is scored: a task blocked only by an open
> decision (O2 or O5) is `[?]`; every other task whose only former blocker is now a closed decision
> is `[ ]` ready. Artifact completeness below is a per-feature prerequisite, not a certification that
> every task may start.
...
The **Artifacts** column certifies only that the feature's documentation set is accepted. The
**Blocked tasks** column carries the per-task gate: the named tasks are `[?]` (an open decision must
be answered first); all other tasks in the feature are ready.

| Feature | idea-brief | PRD | SAD | data-model | contracts | tasks | test-plan | Artifacts | Blocked tasks |
|---|---|---|---|---|---|---|---|---|---|
| [[features/f0-platform-foundation/index\|F0 Platform foundation]] | — | ✅ | ✅ | ✅ | — | ✅ | ✅ | ✅ | none |
| [[features/f1-ats-job-discovery/index\|F1 ATS job discovery]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none (O1 closed) |
| [[features/f2-normalization-dedup/index\|F2 Normalization & dedup]] | — | ✅ | ✅ | ✅ | — | ✅ | ✅ | ✅ | none (O3, O6 closed) |
| [[features/f3-claude-batch-enrichment/index\|F3 Claude batch enrichment]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none |
| [[features/f4-cv-matching-ranking/index\|F4 CV matching & ranking]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none (O10 closed) |
| [[features/f5-daily-digest-telegram/index\|F5 Daily digest & Telegram]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none (O8 closed) |
| [[features/f6-application-tracking/index\|F6 Application tracking]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none |
| [[features/f7-preference-learning/index\|F7 Preference learning]] | — | ✅ | ✅ | ✅ | — | ✅ | ✅ | ✅ | **T07 `[?]`** — blocked by O5 |
| [[features/f8-company-research-agent/index\|F8 Company research agent]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none (O4 closed) |
| [[features/f9-search-and-api/index\|F9 Search & API]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | **T04 `[?]`** — blocked by O2 (O12 closed) |
| [[features/f10-telegram-commands/index\|F10 Telegram commands]] | — | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | none |
...
Only **O2** (blocks F9 T04) and **O5** (blocks F7 T07) remain open — see [[ARCHITECTURE-OPEN-DECISIONS]]
and [[AUDIT-RESOLUTION-DECISIONS]] §7. Every other former blocker is a now-closed decision.
...
underlying feature does. F5 T11 ships seven commands, of which `/start`, `/help` and `/digest` are
the bootstrap subset; the remaining commands land with F10 and its dependencies.
