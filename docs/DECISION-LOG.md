...
- [x] ✅ **English for identifiers, comments, logs, docs and digest copy.**
  *Why:* the reviewer audience is international, and mixed-language codebases age badly. Unlike
  `sentra`, there is no bilingual `.uk.md` tier here — that exists there to serve a stakeholder
  conversation this project does not have.
