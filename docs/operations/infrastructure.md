...
**The backup job is only real once the restore has been rehearsed** — tracked as a blocker in
[[../BACKLOG]] §5.
...
2. **Prompt caching of the CV prefix** — the CV (~2 000 tokens) and system prompt (~400) are
   ...
   0.1× ([[../engineering/deployment|caching applies to batch submissions]]).
