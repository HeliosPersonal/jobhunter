...
- [ ] **Nightly `pg_dump` to Azure Blob**, with a documented and *rehearsed* restore. Currently the largest unmitigated operational risk (R9). #tech #blocker
...
- [?] Company registry seed strategy — [[ARCHITECTURE-OPEN-DECISIONS\|O1]], blocks F1 T3. #blocker
- [?] Is the API internet-facing — [[ARCHITECTURE-OPEN-DECISIONS\|O2]], blocks F9 T8.
- [?] F8 research via Claude web search or curated fetchers — [[ARCHITECTURE-OPEN-DECISIONS\|O4]], blocks F8 T2.
- [?] Salary floor: hard filter or down-weight — [[ARCHITECTURE-OPEN-DECISIONS\|O5]], blocks F7 T5.
