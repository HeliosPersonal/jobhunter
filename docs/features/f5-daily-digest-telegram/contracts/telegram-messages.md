...
> This is the **minimal** set that ships with F5 so the digest is usable on its own. The full
> twenty-command surface, the registry that keeps it honest, and the multi-step and confirmation
> flows are [[../../f10-telegram-commands/index|F10]].
