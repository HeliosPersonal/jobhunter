...
**Given** a request to reprocess normalisation over a period
**When** it arrives without the operator scope (`jobhunter:admin`)
**Then** it is refused and no job is recomputed.
...
- [x] Coverage types: happy (01, 05, 09), error (04), authorization (AC-11, reprocess scope), domain invariant (02, 03, 08), cross-context (06, 07, 10)
