...
The 07:00 digest is the product's heartbeat, but it is a *push*. F10 is the **pull** side: twenty
...
4. [[contracts/command-catalogue|Command catalogue]] — all twenty commands, arguments, output shapes
