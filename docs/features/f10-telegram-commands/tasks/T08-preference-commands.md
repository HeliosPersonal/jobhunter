...
- `/cv` shows version, activation date and current match count, and **no CV content whatsoever** — asserted by the F4 sentinel scan extended to cover this path.
- A CV upload confirms both consequences (re-staling and re-match) and the estimated cost before acting.
