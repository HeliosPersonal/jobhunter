...
Create the `.slnx` solution with the twelve projects of [[../sad|SAD]] §5, plus the four
test projects. Author `Directory.Build.props` (net10.0, nullable, implicit usings,
