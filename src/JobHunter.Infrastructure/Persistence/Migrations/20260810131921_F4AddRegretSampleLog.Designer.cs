...
namespace JobHunter.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260810131921_F4AddRegretSampleLog")]
    partial class F4AddRegretSampleLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobHunter.Domain.Commands.CommandInvocation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<short>("ArgCount")
                        .HasColumnType("smallint")
                        .HasColumnName("arg_count");
                    ...
                    b.HasIndex("InvokedAt")
                        .HasDatabaseName("idx_command_invocations_time");

                    b.HasIndex("Command", "InvokedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("idx_command_invocations_command");

                    b.HasIndex("Outcome", "InvokedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("idx_command_invocations_outcome");

                    b.ToTable("command_invocations", (string)null);
                });
            ...
            modelBuilder.Entity("JobHunter.Domain.Companies.Company", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FirmographicsObservedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("firmographics_observed_at");
            ...
            modelBuilder.Entity("JobHunter.Domain.Ratings.RatingRound", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("WeekStart", "ChatId")
                        .IsUnique()
                        .HasDatabaseName("uq_rating_round");

                    b.ToTable("rating_round_log", (string)null);
                });

            modelBuilder.Entity("JobHunter.Domain.Ratings.RegretSample", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("regret_sample_log", (string)null);
                });
            ...
            modelBuilder.Entity("JobHunter.Domain.Research.ResearchRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("research_requests", (string)null);
                });
